...
export const affixedFormPairs = [
  ...
  {
    sourceRef: "lesson-29/morphology/memper-pendek-memperpendek",
    patternSourceRef: "l29-memper-diper-de-intensieve-causatieve-werkwoordsvorm",
    affix: "memper-",
    root: "pendek",
    derived: "memperpendek",
    allomorphRule: "memper- wordt voorgevoegd: pendek → memperpendek.",
    affixType: "prefix",
    affixGloss: "causative (intensifying)",
    allomorphClass: null,
    productive: true,
    derivedGlossNl: "verkorten, korter maken",
    derivedGlossEn: "to shorten, to make shorter",
  },
  {
    sourceRef: "lesson-29/morphology/memper-aman-memperaman",
    patternSourceRef: "l29-memper-diper-de-intensieve-causatieve-werkwoordsvorm",
    affix: "memper-",
    root: "aman",
    derived: "memperaman",
    allomorphRule: "memper- wordt voorgevoegd: aman → memperaman.",
    affixType: "prefix",
    affixGloss: "causative (intensifying)",
    allomorphClass: null,
    productive: true,
    derivedGlossNl: "beveiligen, veiliger maken",
    derivedGlossEn: "to secure, to make safe",
  },
  {
    sourceRef: "lesson-29/morphology/memper-singkat-mempersingkat",
    patternSourceRef: "l29-memper-diper-de-intensieve-causatieve-werkwoordsvorm",
    affix: "memper-",
    root: "singkat",
    derived: "mempersingkat",
    allomorphRule: "memper- wordt voorgevoegd: singkat → mempersingkat.",
    affixType: "prefix",
    affixGloss: "causative (intensifying)",
    allomorphClass: null,
    productive: true,
    derivedGlossNl: "verkorten",
    derivedGlossEn: "to shorten",
  },
  {
  ...
  {
    sourceRef: "lesson-29/morphology/per-…-anair-perairan",
    patternSourceRef: "l29-per-an-het-nominaliserende-omhulsel-confix",
    affix: "per-…-an",
    root: "air",
    derived: "perairan",
    allomorphRule: "per-…-an: voorvoegsel per- met achtervoegsel -an: air → perairan.",
    affixType: "confix",
    affixGloss: "collective / result nominaliser",
    allomorphClass: null,
    productive: true,
    circumfixLeft: "per",
    circumfixRight: "an",
    carrierText: "Banyak nelayan asing menangkap ikan di perairan Indonesia",
    derivedGlossNl: "wateren, watergebied",
    derivedGlossEn: "waters, water territory",
  },
  {
    sourceRef: "lesson-29/morphology/per-…-anhati-perhatian",
    patternSourceRef: "l29-per-an-het-nominaliserende-omhulsel-confix",
    affix: "per-…-an",
    root: "hati",
    derived: "perhatian",
    allomorphRule: "per-…-an: voorvoegsel per- met achtervoegsel -an: hati → perhatian.",
    affixType: "confix",
    affixGloss: "collective / result nominaliser",
    allomorphClass: null,
    productive: true,
    circumfixLeft: "per",
    circumfixRight: "an",
    derivedGlossNl: "aandacht, belangstelling",
    derivedGlossEn: "attention, interest",
  },
  {
    sourceRef: "lesson-29/morphology/per-…-anminta-permintaan",
    patternSourceRef: "l29-per-an-het-nominaliserende-omhulsel-confix",
    affix: "per-…-an",
    root: "minta",
    derived: "permintaan",
    allomorphRule: "per-…-an: voorvoegsel per- met achtervoegsel -an: minta → permintaan.",
    affixType: "confix",
    affixGloss: "collective / result nominaliser",
    allomorphClass: null,
    productive: true,
    circumfixLeft: "per",
    circumfixRight: "an",
    derivedGlossNl: "verzoek, vraag, eis",
    derivedGlossEn: "request, demand",
  },
  {
    sourceRef: "lesson-29/morphology/per-…-anmakan-permakanan",
    patternSourceRef: "l29-per-an-het-nominaliserende-omhulsel-confix",
    affix: "per-…-an",
    root: "makan",
    derived: "permakanan",
    allomorphRule: "per-…-an: voorvoegsel per- met achtervoegsel -an: makan → permakanan.",
    affixType: "confix",
    affixGloss: "collective / result nominaliser",
    allomorphClass: null,
    productive: true,
    circumfixLeft: "per",
    circumfixRight: "an",
    derivedGlossNl: "voedselvoorziening, voeding",
    derivedGlossEn: "food supply, provisions",
  },
  {
    sourceRef: "lesson-29/morphology/per-…-anbank-perbankan",
    patternSourceRef: "l29-per-an-het-nominaliserende-omhulsel-confix",
    affix: "per-…-an",
    root: "bank",
    derived: "perbankan",
    allomorphRule: "per-…-an: voorvoegsel per- met achtervoegsel -an: bank → perbankan.",
    affixType: "confix",
    affixGloss: "collective / result nominaliser",
    allomorphClass: null,
    productive: true,
    circumfixLeft: "per",
    circumfixRight: "an",
    derivedGlossNl: "bankwezen",
    derivedGlossEn: "banking sector",
  },
  {
    sourceRef: "lesson-29/morphology/per-…-anguru-perguruan",
    patternSourceRef: "l29-per-an-het-nominaliserende-omhulsel-confix",
    affix: "per-…-an",
    root: "guru",
    derived: "perguruan",
    allomorphRule: "per-…-an: voorvoegsel per- met achtervoegsel -an: guru → perguruan.",
    affixType: "confix",
    affixGloss: "collective / result nominaliser",
    allomorphClass: null,
    productive: true,
    circumfixLeft: "per",
    circumfixRight: "an",
    derivedGlossNl: "onderwijsinstelling / onderwijswereld",
    derivedGlossEn: "educational institution / world of education",
  },
  {
