        ...
        "sections": [
          {
            ...
            "items": [
              {
                "prompt": "auto - snel",
                "answer": "Mobil ini cepat / Mobil ini lebih cepat daripada mobil itu / Mobil ini paling cepat (of: tercepat)"
              },
              {
                "prompt": "stoel - oud",
                "answer": "Kursi ini tua / Kursi ini lebih tua daripada kursi itu / Kursi ini paling tua (of: tertua)"
              },
              {
                "prompt": "boek - makkelijk",
                "answer": "Buku ini mudah / Buku ini lebih mudah daripada buku itu / Buku ini paling mudah (of: termudah)"
              },
              {
                "prompt": "hotel - duur",
                "answer": "Hotel ini mahal / Hotel ini lebih mahal daripada hotel itu / Hotel ini paling mahal (of: termahal)"
              },
              {
                "prompt": "school - goed",
                "answer": "Sekolah ini bagus / Sekolah ini lebih bagus daripada sekolah itu / Sekolah ini paling bagus (of: terbagus)"
              },
              {
                "prompt": "koffer - vol",
                "answer": "Koper ini penuh / Koper ini lebih penuh daripada koper itu / Koper ini paling penuh"
              },
              {
                "prompt": "land - groot",
                "answer": "Negara ini besar / Negara ini lebih besar daripada negara itu / Negara ini paling besar (of: terbesar)"
              },
              {
                "prompt": "banaan - rijp",
                "answer": "Pisang ini masak / Pisang ini lebih masak daripada pisang itu / Pisang ini paling masak"
              },
              {
                "prompt": "bord - goedkoop",
                "answer": "Piring ini murah / Piring ini lebih murah daripada piring itu / Piring ini paling murah (of: termurah)"
              },
              {
                "prompt": "kleur - licht",
                "answer": "Warna ini muda / Warna ini lebih muda daripada warna itu / Warna ini paling muda"
              }
            ]
          },
          {
          ...
          },
          {
            ...
            "items": [
              {
                "prompt": "Mijn koffer is even zwaar als jouw koffer",
                "answer": "Koper saya sama berat dengan kopermu"
              },
              {
                "prompt": "Mijn oudere broer is veel groter dan haar vriend",
                "answer": "Kakak saya jauh lebih besar daripada temannya"
              },
              {
                "prompt": "Zijn auto is even snel als onze auto",
                "answer": "Mobilnya sama cepat dengan mobil kami"
              },
              {
                "prompt": "Dit oude hotel is goedkoper dan het nieuwe hotel",
                "answer": "Hotel lama ini lebih murah daripada hotel baru"
              },
              {
                "prompt": "Deze trap is langer dan de trap aan de voorkant van onze school",
                "answer": "Tangga ini lebih panjang daripada tangga di depan sekolah kami"
              },
              {
                "prompt": "Deze dame is even oud als mijn grootmoeder",
                "answer": "Ibu ini sama tua dengan nenek saya"
              },
              {
                "prompt": "Hoeveel jaren ben jij ouder dan jouw broertje?",
                "answer": "Berapa tahun kamu lebih tua daripada adikmu?"
              },
              {
                "prompt": "Vroeger waren de mensen kleiner dan tegenwoordig",
                "answer": "Dulu orang lebih kecil daripada sekarang"
              },
              {
                "prompt": "Ik ben van mening dat jullie morgen moeten komen",
                "answer": "Saya rasa kalian harus datang besok"
              },
              {
                "prompt": "Deze week zijn er meer feesten dan vorige week",
                "answer": "Minggu ini ada lebih banyak pesta daripada minggu lalu"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "prompt": "In mei gaat Henk naar Indonesie. Hij vliegt met een vliegtuig van Garuda. In Jakarta verblijft hij in een nieuw, groot hotel. Na zes dagen gaat hij naar Surabaya. Daar woont een vriend van hem die Mardi heet.",
                "answer": "Pada bulan Mei Henk pergi ke Indonesia. Dia naik kapal terbang Garuda. Di Jakarta dia tinggal di hotel baru yang besar. Sesudah enam hari dia pergi ke Surabaya. Di sana tinggal temannya yang bernama Mardi."
              },
              {
                "prompt": "Goedenavond! Hoe gaat het? Goed, dank u wel. Bent u al naar de kraton in Yogya geweest? Nog niet, morgen gaan we daarheen. Oh, in dat geval moet u niet vergeten ook naar het paleis te gaan.",
                "answer": "Selamat malam! Apa kabar? Baik, terima kasih. Anda sudah ke kraton di Yogya? Belum, besok kami pergi ke sana. Oh, kalau begitu jangan lupa juga pergi ke istana."
              },
              {
                "prompt": "Wij gaan vanavond eten in het eethuisje van Pak Hasan. Het eten is daar erg lekker. Het is daarom altijd erg druk. Het eethuisje van Pak Hasan is kleiner dan het nieuwe 'Satay House'.",
                "answer": "Nanti malam kami mau makan di warung Pak Hasan. Makanan di sana enak sekali. Karena itu selalu ramai sekali. Warung Pak Hasan lebih kecil daripada 'Satay House' yang baru."
              },
              {
                "prompt": "Zij zijn vandaag naar de markt geweest. De spullen staan nu in de keuken. Ze hebben ook een verjaardagskado gekocht voor Susi. Woensdag is de verjaardag van Susi.",
                "answer": "Hari ini mereka sudah ke pasar. Barangnya sekarang ada di dapur. Mereka juga sudah beli hadiah ulang tahun untuk Susi. Hari Rabu adalah hari ulang tahun Susi."
              },
              {
                "prompt": "Meneer, wij zoeken het postkantoor. Het nieuwe of het oude? Het nieuwe postkantoor is het grootste in de stad, maar is erg ver hier vandaan. Het oude postkantoor is dichtbij. Eerst gaat u naar links tot aan de brug, daarna naar rechts. Het oude postkantoor ligt rechts van Pasar Senen. Dank u wel, meneer.",
                "answer": "Pak, kami cari kantor pos. Yang baru atau yang lama? Kantor pos baru paling besar di kota, tetapi jauh sekali dari sini. Kantor pos lama dekat. Pertama Bapak ke kiri sampai jembatan, sesudah itu ke kanan. Kantor pos lama di sebelah kanan Pasar Senen. Terima kasih, Pak."
              }
            ]
          }
        ]
