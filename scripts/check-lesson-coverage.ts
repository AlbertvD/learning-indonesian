...
await cnt('  …source_kind = item:', sb.schema('indonesian')
  .from('learning_capabilities').select('*', { count: 'exact', head: true }).eq('source_kind', 'vocabulary_src'))
await cnt('  …source_kind = pattern:', sb.schema('indonesian')
  .from('learning_capabilities').select('*', { count: 'exact', head: true }).eq('source_kind', 'grammar_pattern_src'))
await cnt('  …source_kind = dialogue_line:', sb.schema('indonesian')
  .from('learning_capabilities').select('*', { count: 'exact', head: true }).eq('source_kind', 'dialogue_line_src'))
await cnt('  …source_kind = word_form_pair_src:', sb.schema('indonesian')
  .from('learning_capabilities').select('*', { count: 'exact', head: true }).eq('source_kind', 'word_form_pair_src'))
