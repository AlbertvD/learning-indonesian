...
export function instructionPrompt(meta: EpisodeMeta, lang: Lang): string {
  ...
  if (lang === 'nl') {
    ...
    return [
      ...
      `Spreek alle Indonesische woorden — de naam 'Kamoe Bisa' én alle Indonesische voorbeelden — uit met correcte, authentieke Indonesische uitspraak, ook al spreek je verder Nederlands; pas geen Nederlandse klanken toe op Indonesische woorden. Spreek Indonesische achtervoegsels en clitica volledig op zijn Indonesisch uit en hecht ze vast aan het werkwoord — bijvoorbeeld -ku als 'koe', -mu als 'moe', -nya als 'nja' — nooit als losse lettergrepen of als namen.`,
      `Bespreek elk grammaticapunt uit het bronmateriaal helder en gedetailleerd, met de Indonesische voorbeelden.`,
      `Volg het bronmateriaal nauwkeurig: leg precies de regels en voorbeelden uit die erin staan, en voeg geen regels, uitzonderingen of gebruiksvormen toe die er niet in staan.`,
      ...
      `Houd het warm en bemoedigend, en spreek in een rustig, gelijkmatig en ongehaast tempo, zonder te versnellen of te vertragen. Sla geen enkel punt over. Spreek volledig in het Nederlands. Noem deze aflevering nooit een 'Deep Dive' of 'diepe duik' — het is gewoon de grammaticales bij deze les in de app. Noem Google, NotebookLM, 'Deep Dive' of andere product- of bronnamen niet.`,
    ].join(' ')
  }
  ...
  return [
    ...
    `Pronounce all Indonesian words — the show name 'Kamoe Bisa' and every Indonesian example — with correct, authentic Indonesian pronunciation, even though you otherwise speak English; do not apply English sounds to Indonesian words. Pronounce Indonesian suffixes and clitics fully in Indonesian and attach them to the verb — for example -ku as 'koo', -mu as 'moo', -nya as 'nyah' — never as separate syllables or as names.`,
    `Discuss every grammar point in the source material clearly and in detail, with the Indonesian examples.`,
    `Follow the source material precisely: explain exactly the rules and examples it contains, and do not add rules, exceptions, or usages that are not in it.`,
    ...
    `Keep it warm and encouraging, and speak at a calm, steady, unhurried pace without speeding up or slowing down. Don't skip any point. Speak entirely in English. Never call this episode a 'Deep Dive' — it is simply the grammar lesson for this lesson in the app. Do not mention Google, NotebookLM, 'Deep Dive', or any other product or source name.`,
  ].join(' ')
}
