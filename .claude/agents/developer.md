...
tools: Read, Write, Edit, Bash, Grep, Glob, mcp__openbrain__match_deployment_lessons, mcp__openbrain__search_deployment_lessons, mcp__openbrain__add_deployment_lesson, mcp__openbrain__add_thought
model: sonnet
---
