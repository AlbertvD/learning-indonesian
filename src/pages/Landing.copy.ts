...
const nl = {
  ...
  bridgeEdge: 'Dit is een voorsprong die alleen jij hebt. Wie Indonesisch leert via het Engels — en dat is bij elke grote app de enige optie — heeft er niets aan.',
...
const en: typeof nl = {
  ...
  bridgeEdge: 'This head start is yours alone. Anyone learning Indonesian through English — the only option every big app offers — cannot use it.',
