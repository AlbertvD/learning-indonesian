        ...
        {pairs.map(([act, pas], i) => (
          <div key={i} className={classes.flipPair}>
            <div className={classes.flipRow} data-voice="active">
              ...
              <span className={classes.flipId}>{act.indonesian}<AudioPlayButton src={act.audioUrl} className={classes.playButton} /></span>
            ...
            <div className={classes.flipRow} data-voice="passive">
              ...
              <span className={classes.flipId}>{pas.indonesian}<AudioPlayButton src={pas.audioUrl} className={classes.playButton} /></span>
          ...
          <div className={classes.tileExamples}>
            {cat.examples.map((ex, j) => (
              <div key={j} className={classes.exPair}>
                <span className={classes.exId}>{ex.indonesian}<AudioPlayButton src={ex.audioUrl} className={classes.playButton} /></span>
