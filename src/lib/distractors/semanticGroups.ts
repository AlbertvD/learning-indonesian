...
//
// Moved from src/lib/semanticGroups.ts as part of PR-1 of the
// capabilityContentService spec. The original path now contains a re-export
// shim so existing importers compile unchanged.
